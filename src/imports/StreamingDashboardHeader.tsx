...
const TAB_TITLE_KEYS: Record<string, string> = {
    ...
    performance: "dashboard.tabActivity",
    playlists: "dashboard.tabSongs",
...
export default function StreamingDashboardHeader({ activeTab = "dashboard", direction = 0 }: StreamingDashboardHeaderProps) {
  ...
  return (
    <div className="flex flex-col gap-[2px] px-1 w-full relative overflow-hidden items-center">
      <div className="w-full">
         <h2 className="font-manrope font-bold text-[22px] text-white text-center leading-tight">Streaming</h2>
      </div>
