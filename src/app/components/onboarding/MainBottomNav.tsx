...
/**
 * TAF (Transmigrated Astral Flow) Protocol - MAIN NAV:
 * 1. Synchronized with the top tabs for global category transmigration.
 * 2. Visual identity matches the glass-morphism dashboard standard.
 * 3. Spring physics (105/18) for the Ethereal Jump.
 */
export const MainBottomNav = ({ activeTab, onTabChange, isVisible }: MainBottomNavProps) => {
        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    exit={{ opacity: 0, y: 0, transition: { duration: 0.3, delay: 0.1 } }}
                    transition={{ 
                        type: "spring", 
                        stiffness: 82, 
                        damping: 24, 
                ...
                >
                     {navItems.map((item, index) => {
                          ...
                          // Mapping colors based on Tab ID
                              ...
                              >
                                  ...
                                  {isActive && (
                                      <motion.div 
                                         ...
                                         style={{ backgroundColor: `${activeColor}26` }} // 26 is ~15% opacity in hex
                                  ...
                                  <div className="h-[22px] flex items-center justify-center relative overflow-visible">
                                      <motion.span
                                        ...
                                        // Force clear styles on exit to ensure visibility for transfer
